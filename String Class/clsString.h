...
public:
    ...
    static int Length(const string& S1)
    {
        return S1.length();
    };
    ...
    static void Print1stLettersOfWords(const string& str)
    {
    ...
    short CountCapitalLetters()
   {
    ...
    static short CountVowel(const string& str)
    {
        short count = 0;
    ...
    static void PrintVowels(const string& str)
    {
        for (int i = 0; i < str.length(); i++)
        {
            if (IsVowel(str[i]))
    ...
    static string RemoveAllPunct(const string& str)
    {
        string New = "";
