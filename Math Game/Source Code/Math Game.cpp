...
enOperationType ReadOpType()
{
	...
	do
	{
		cout << "Enter Operation Type [1] Add, [2] Subtraction, [3] Multiply, [4] Divide, [5] Mix ? ";
		cin >> OpType;
...
string GetQuestionLevelText(enQuestionLevel QuerstionLevel)
{
	string arrQuestionLevel[4] = { "Easy", "Med", "Hard", "Mix" };
	return arrQuestionLevel[QuerstionLevel - 1];
}
...
void PrintQuizzResult(sQuizz Quizz)
{
	...
	cout << "Operation Type        : " << GetOpTypeSymbole(Quizz.OpType) << endl;
